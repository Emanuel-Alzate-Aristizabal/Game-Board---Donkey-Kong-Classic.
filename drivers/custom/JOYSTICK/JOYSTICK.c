...
void JOYSTICK_init(void){
	 ...
	 ****************************************************/
	adc16_hardware_compare_config_t adc16HardwareCompareStruct={kADC16_HardwareCompareMode2,
	...
	ADC16_SetHardwareCompareConfig(GAME_BOARD_JOYSTICK_ADC_BASE, &adc16HardwareCompareStruct);
...
void GAME_BOARD_JOYSTICK_ADC_IRQ_HANDLER_FUNC(void){
	...
	if(JOYSTICK_ChannelConfigStruct.channelNumber == GAME_BOARD_JOYSTICK_CHANNEL_X){
 ...
 ********************************************************************/
	 ...
	 if(JOYSTICK_ChannelConfigStruct.channelNumber == GAME_BOARD_JOYSTICK_CHANNEL_X){
		 JOYSTICK_ChannelConfigStruct.channelNumber = GAME_BOARD_JOYSTICK_CHANNEL_Y;
	 }else{
		 JOYSTICK_ChannelConfigStruct.channelNumber = GAME_BOARD_JOYSTICK_CHANNEL_X;
	 }
	 ADC16_SetChannelConfig( GAME_BOARD_JOYSTICK_ADC_BASE,
